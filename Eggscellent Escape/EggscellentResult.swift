...
enum EggscellentWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: EggscellentWebStatus) -> Bool {
        switch (self, other) {
...
extension EggscellentWebStatus {
...
extension EggscellentWebStatus {
    static func == (lhs: EggscellentWebStatus, rhs: EggscellentWebStatus) -> Bool {
