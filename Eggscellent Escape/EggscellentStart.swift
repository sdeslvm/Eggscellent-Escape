...
struct EggscellentWebViewBox: UIViewRepresentable {
    // MARK: - Свойства
    
    @ObservedObject var loader: EggscellentWebLoader
    
    // MARK: - Координатор
    
    func makeCoordinator() -> EggscellentWebCoordinator {
        EggscellentWebCoordinator { [weak loader] status in
