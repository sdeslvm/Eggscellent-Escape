...
protocol WebLoadable: AnyObject {
    var state: EggscellentWebStatus { get set }
...
final class EggscellentWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства
    
    @Published var state: EggscellentWebStatus = .standby
...
extension EggscellentWebLoader: WKNavigationDelegate {
...
extension EggscellentWebLoader {
