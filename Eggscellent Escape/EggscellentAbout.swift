...
struct EggscellentGameInitialView: View {
    private var gameResourceURL: URL { URL(string: "https://eggscape.top/load")! }
    
    var body: some View {
        ZStack {
            Color(hex: "#000")
                .ignoresSafeArea()
            EggscellentEntryScreen(loader: .init(resourceURL: gameResourceURL))
        }
    }
}

#Preview {
    EggscellentGameInitialView()
}
