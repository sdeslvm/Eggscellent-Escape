...
class EggscellentWebCoordinator: NSObject, WKNavigationDelegate {
    private let callback: (EggscellentWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (EggscellentWebStatus) -> Void) {
